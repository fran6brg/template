    ...
    return (
        ...
        >
            <div
                {...props}
                className={cn(
                    'mx-auto mb-10 pb-28 mt-24 flex max-w-[600px] flex-col items-start overflow-auto px-4 sm:max-w-[700px] sm:px-16 md:mt-28 lg:mt-32 md:max-w-[700px] xl:max-w-[800px]',
